...
public class HibernateUtil {
    ...
    protected List<Klient> listClients(){
    ...
    protected void saveClient(String imie, String nazwisko)throws Exception{
    ...
    protected void modifyClient(String imie, String nazwisko, Long id){
